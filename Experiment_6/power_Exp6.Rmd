...
We further use the modeling results to produce the expected difference between the categories. 

```{r}
# data from model
model_data <- read_csv("../experiment_4/data/model_3_options.csv") %>% 
...
beta_ci  <- 5 # difference in effect of convergence when number of options = 10 (compared to conflict of interest)
